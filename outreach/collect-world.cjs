...
const NICHES = ["mobile mechanic", "plumber", "roofer", "lawn care", "painter", "electrician", "handyman", "house cleaner", "pressure washing", "auto detailer"];
const CITIES = [
  ["New York","US"],["Los Angeles","US"],["Chicago","US"],["Houston","US"],["Phoenix","US"],["Philadelphia","US"],["San Antonio","US"],["San Diego","US"],["Dallas","US"],["Austin","US"],["Miami","US"],["Atlanta","US"],["Seattle","US"],["Denver","US"],["Boston","US"],["Las Vegas","US"],["Portland","US"],["Nashville","US"],["Charlotte","US"],["Tampa","US"],["Orlando","US"],["Raleigh","US"],["Salt Lake City","US"],["Kansas City","US"],["Columbus","US"],
  ["Toronto","CA"],["Vancouver","CA"],["Montreal","CA"],["Calgary","CA"],["Ottawa","CA"],["Edmonton","CA"],
  ["London","GB"],["Manchester","GB"],["Birmingham","GB"],["Leeds","GB"],["Glasgow","GB"],["Liverpool","GB"],["Bristol","GB"],
  ["Dublin","IE"],["Sydney","AU"],["Melbourne","AU"],["Brisbane","AU"],["Perth","AU"],["Adelaide","AU"],["Auckland","NZ"],
  ["Berlin","DE"],["Munich","DE"],["Frankfurt","DE"],["Hamburg","DE"],["Paris","FR"],["Lyon","FR"],["Madrid","ES"],["Barcelona","ES"],["Rome","IT"],["Milan","IT"],["Amsterdam","NL"],["Brussels","BE"],["Lisbon","PT"],["Zurich","CH"],["Vienna","AT"],["Stockholm","SE"],["Copenhagen","DK"],["Oslo","NO"],["Helsinki","FI"],["Warsaw","PL"],["Prague","CZ"],["Athens","GR"],
  ["Mexico City","MX"],["Guadalajara","MX"],["Monterrey","MX"],["São Paulo","BR"],["Rio de Janeiro","BR"],["Buenos Aires","AR"],["Bogotá","CO"],["Lima","PE"],["Santiago","CL"],["Medellín","CO"],["Quito","EC"],["Montevideo","UY"],
  ["Tokyo","JP"],["Osaka","JP"],["Seoul","KR"],["Singapore","SG"],["Hong Kong","HK"],["Taipei","TW"],["Bangkok","TH"],["Manila","PH"],["Jakarta","ID"],["Kuala Lumpur","MY"],["Mumbai","IN"],["Delhi","IN"],["Bangalore","IN"],["Hyderabad","IN"],["Chennai","IN"],["Dubai","AE"],["Abu Dhabi","AE"],["Tel Aviv","IL"],["Istanbul","TR"],["Karachi","PK"],["Lahore","PK"],["Ho Chi Minh City","VN"],["Hanoi","VN"],["Shanghai","CN"],["Beijing","CN"],["Shenzhen","CN"],["Guangzhou","CN"],
  ["Johannesburg","ZA"],["Cape Town","ZA"],["Nairobi","KE"],["Lagos","NG"],["Accra","GH"],["Cairo","EG"],["Casablanca","MA"],["Riyadh","SA"],["Doha","QA"],["Kuwait City","KW"],["Amman","JO"]
];
